...
/*   Updated: 2024/05/15 16:57:28 by anovio-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int executor(t_mini *mini)
{
	...
	fd_in_start = dup(STDIN_FILENO);
	//fd_out_start = STDOUT_FILENO;
	//fprintf(stderr, "stdin start %d stdout %d\n", STDIN_FILENO, STDOUT_FILENO);
	...
	dup2(fd_in_start, STDIN_FILENO);
	close(fd_in_start);
	//dup2(STDOUT_FILENO, fd_out_start);
	//fprintf(stderr, "stdin start %d stdout %d\n", fd_in_start, STDOUT_FILENO);	
	return (0);
